...
- (Coming soon) Next.js / React Server Components
- (Coming soon) SvelteKit islands

Contributions welcome—open an issue if you’d like to document another integration.
