...
- `astro-integration.md` — how to consume the package inside Astro (SSR-safe entry, client islands, memory adapter for tests).
...
- `tutorials/migrations.md` — explains schema versioning, additive upgrades, and how to hook custom migration logic.
